...
enum DictionaryKey: string implements DictionaryKeyInterface {
    ...
    public function getValueTypes(): array {
        return match ($this) {
            ...
            self::ANNOTS => [ReferenceValueArray::class, DictionaryArrayValue::class],
            ...
            self::CONTENTS => [ReferenceValueArray::class, TextStringValue::class],
            ...
            self::FIELDS => [ReferenceValueArray::class, DictionaryArrayValue::class],
            ...
            self::ORDER => [IntegerValue::class, ArrayValue::class, ReferenceValueArray::class],
            ...
            self::OUTPUT_INTENTS => [ReferenceValueArray::class, DictionaryArrayValue::class],
